...
public class Employee_DAO_Imp  implements Employee_DAO{
	...
	public List<Employee> getEmployees() {
		...
		System.out.println("inside getEmployee >>>"+ list.size());
		return list;
	}
	...
	public List<Employee> getEmployeeByID(Employee employee) {
		Session currentSession = sessionFactory.getCurrentSession();
		Query<Employee> query=currentSession.createQuery("from Employe where employee_id=:employee_id", Employee.class);
